...
if (item.category_id === 1){
    $('.read-container').append(`<ul><li>- ${item.user_description}</li><div class="forms-container"><form class="delete-forms">
      <button type='submit'>Delete</button></form><form method="GET" action="/change-category" class="change-category-forms">
      <button type='submit'>Change a category</button></form></div></ul>`);
  }
      else if (item.category_id === 2){

        $('.watch-container').append(`<ul><li>- ${item.user_description}</li><div class="forms-container"><form class="delete-forms">
      <button type='submit'>Delete</button></form><form method="GET" action="/change-category" class="change-category-forms">
      <button type='submit'>Change a category</button></form></div></ul>`);
 }
      else if (item.category_id === 3){

        $('.buy-container').append(`<ul><li>- ${item.user_description}</li><div class="forms-container"><form class="delete-forms">
      <button type='submit'>Delete</button></form><form method="GET" action="/change-category" class="change-category-forms">
      <button type='submit'>Change a category</button></form></div></ul>`);
     }
     else if (item.category_id === 4){
      $('.eat-container').append(`<ul><li>- ${item.user_description}</li><div class="forms-container"><form class="delete-forms">
      <button type='submit'>Delete</button></form><form method="GET" action="/change-category" class="change-category-forms">
      <button type='submit'>Change a category</button></form></div></ul>`);
   }
     else if (item.category_id === 5){
      $('.other-container').append(`<ul><li>- ${item.user_description}</li><div class="forms-container"><form class="delete-forms">
      <button type='submit'>Delete</button></form><form method="GET" action="/change-category" class="change-category-forms">
      <button type='submit'>Change a category</button></form></div></ul>`);
     }
}
